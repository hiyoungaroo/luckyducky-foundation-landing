  ...
  return (
    ...
    >
      ...
      <p className="max-w-lg text-sm text-center mx-auto mt-4 text-neutral-400">
        Earn crypto rewards through Web3 social gaming and manage your digital assets
        with cutting-edge tools designed for everyone—from beginners to pros.
      </p>
      <div className="mt-20  grid cols-1 lg:grid-cols-5 gap-4 auto-rows-[25rem] max-w-3xl mx-auto lg:max-w-none">
        <Card className="flex flex-col relative justify-between lg:col-span-2">
          ...
          <CardContent className="h-40 absolute bottom-0">
            ...
            <CardDescription>
              Earn crypto rewards through engaging social games powered by our
        ...
        <Card className="flex flex-col relative justify-between lg:col-span-3">
          ...
          <CardContent className="h-40 relative mb-4">
            ...
            <CardDescription>
              Join our growing community of over 500,000 gamers who trust our
              platform for Web3 social gaming and crypto rewards.
            </CardDescription>
          </CardContent>
        ...
        <Card className="flex flex-col justify-between lg:col-span-2">
          <CardContent className="h-40">
            ...
            <CardDescription>
              See what our players are saying about their gaming experience and
              crypto rewards. Join the LuckyDucky community today.
            </CardDescription>
          </CardContent>
          <CardSkeletonBody>
